...
#line 167 "plp5.y"
    ...
    if ((yyvsp[-7].attr)->tipo != (yyvsp[-2].attr)->tipo) {
        msgError(ERR_TIPOSDECLARRAY, nlin, ncol, (yyvsp[-5].attr)->lexema.c_str());
    }
    if ((yyvsp[-6].attr)->ndims != (yyvsp[-1].attr)->ndims) {
        msgError(ERR_DIMSDECLARRAY, nlin, ncol, (yyvsp[-5].attr)->lexema.c_str());
    }
    ...
    if (next_dir + total_tam > 16000) {
        msgError(ERR_NOCABE, nlin, ncol, (yyvsp[-5].attr)->lexema.c_str());
    }

    if (!ts->set(s)) {
        msgError(ERR_YADECL, nlin, ncol, (yyvsp[-5].attr)->lexema.c_str());
    }
    next_dir += total_tam;
    (yyval.attr) = new Atributos();
}
...
#line 202 "plp5.y"
    ...
    s.tam = 0;
    if (!ts->set(s)) {
        msgError(ERR_YADECL, nlin, ncol, (yyvsp[-9].attr)->lexema.c_str());
    }
    (yyval.attr) = new Atributos();
}
...
#line 223 "plp5.y"
    ...
    if (val <= 0) {
        msgError(ERR_DIM, nlin, ncol, (yyvsp[-2].attr)->lexema.c_str());
    }
    (yyval.attr) = (yyvsp[0].attr);
    (yyval.attr)->ndims++;
...
#line 232 "plp5.y"
    ...
    if (val <= 0) {
        msgError(ERR_DIM, nlin, ncol, (yyvsp[-1].attr)->lexema.c_str());
    }
    (yyval.attr) = new Atributos();
    (yyval.attr)->ndims = 1;
...
#line 250 "plp5.y"
    ...
    s.tam = 1;
    if (next_dir + 1 > 16000) {
        msgError(ERR_NOCABE, nlin, ncol, (yyvsp[0].attr)->lexema.c_str());
    }
    if (!ts->set(s)) {
        msgError(ERR_YADECL, nlin, ncol, (yyvsp[0].attr)->lexema.c_str());
    }
    next_dir++;
    (yyval.attr) = new Atributos();
}
...
#line 364 "plp5.y"
    ...
    if (((yyvsp[-2].attr)->tipo == LOGICO && (yyvsp[0].attr)->tipo == LOGICO) || (((yyvsp[-2].attr)->tipo == ENTERO || (yyvsp[-2].attr)->tipo == REAL) && ((yyvsp[0].attr)->tipo == ENTERO || (yyvsp[0].attr)->tipo == REAL))) {
        ...
        msgError(ERR_TIPOS, nlin, ncol, (yyvsp[-1].attr)->lexema.c_str());
    }
    (yyval.attr)->tipo = LOGICO;
    releaseTemp();
}
...
#line 397 "plp5.y"
    ...
    if ((yyvsp[-2].attr)->tipo == REAL || (yyvsp[0].attr)->tipo == REAL) {
        ...
        msgError(ERR_NUM, nlin, ncol, (yyvsp[-1].attr)->lexema.c_str());
    }
    releaseTemp();
}
...
#line 454 "plp5.y"
    ...
    if (!s) msgError(ERR_NODECL, nlin, ncol, (yyvsp[-4].attr)->lexema.c_str());
    if (s->tipo != SCVAR) msgError(ERR_NOSC, nlin, ncol, (yyvsp[-4].attr)->lexema.c_str());
    (yyval.attr) = new Atributos();
...
#line 502 "plp5.y"
    ...
    if (!s) msgError(ERR_NODECL, nlin, ncol, (yyvsp[0].attr)->lexema.c_str());
    if (s->tipo == SCVAR) msgError(ERR_SCVAR, nlin, ncol, (yyvsp[0].attr)->lexema.c_str());
